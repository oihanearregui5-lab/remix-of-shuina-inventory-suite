                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 space-y-2">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {task.scope === "general" ? <span className="rounded-full bg-secondary/80 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wider text-secondary-foreground">General</span> : null}
                      </div>
                      <div>
