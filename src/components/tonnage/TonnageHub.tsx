...
import { BarChart3, Calendar, History, MapPin, Truck, ListChecks } from "lucide-react";
      ...
      <PageHeader
        ...
        description={
          isAdminView
            ...
            : "Registra tus viajes según los hagas. Consulta el histórico cuando quieras."
        }
      />
        ...
        {isAdminView ? (
          ...
          <TabsList className="!grid w-full grid-cols-3 h-auto">
            <TabsTrigger value="registrar" className="gap-2 py-2.5">
              <ListChecks className="h-4 w-4" /> Registrar
            </TabsTrigger>
