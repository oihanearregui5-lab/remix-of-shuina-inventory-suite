  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <PageHeader
        ...
        actions={<><Button size="lg" className="min-w-[180px]" onClick={() => onNavigate("fichajes")}><Clock3 className="h-4 w-4" />{activeEntry ? "Abrir fichaje activo" : "Fichar ahora"}</Button><Button size="lg" variant="outline" onClick={() => onNavigate("tasks")}><ClipboardList className="h-4 w-4" /> Ver tareas</Button></>}
      />
        ...
        <div className="grid gap-6 xl:grid-cols-[1.25fr_0.75fr] xl:items-end">
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <h2 className="max-w-2xl text-3xl font-bold tracking-tight text-foreground md:text-5xl">{activeEntry ? "Tienes la jornada en marcha y todo bajo control." : "Empieza la jornada con un fichaje claro, rápido y verificable."}</h2>
              <p className="max-w-2xl text-sm leading-7 text-muted-foreground md:text-base">Consulta tu estado actual, el tiempo trabajado hoy, el último movimiento registrado y los siguientes compromisos sin perder contexto.</p>
            </div>
